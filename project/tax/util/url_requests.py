...
Theme:重写requests方法，封装请求的方法，去参数，便于调用
"""
...
from requests.exceptions import Timeout, ConnectionError, ProxyError,SSLError
...
def get(url, params=None, **kwargs):
    res = _request('GET', url=url, params=params, **kwargs)
    return res


def post(url, data=None, **kwargs):
    res = _request("POST", url=url, data=data, **kwargs)
    return res
